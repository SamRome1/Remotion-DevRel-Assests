...
const CARD_BG2 = '#252538';
const TEXT     = '#e0e0ef';
const MUTED    = '#6a6a8a';
const ARROW_C  = '#6e6e9e';
const GREEN_F  = '#1e3a2f';
...
// ── Component ─────────────────────────────────────────────────────────────────
export const StorageWorkflowDark: React.FC = () => {
      ...
      >
        <defs>
          ...
          <pattern id="dots" x="0" y="0" width="28" height="28" patternUnits="userSpaceOnUse">
            <circle cx="14" cy="14" r="0.72" fill="#2a2a4a" />
          </pattern>
        </defs>
        ...
        <g opacity={appOp} transform={`translate(0, ${appSlide})`} filter="url(#sk)">
          ...
          <rect x="150" y="118" width="780" height="294" rx="10"
            fill={CARD_BG} stroke={TEXT} strokeWidth="2.8" />

          {/* Browser chrome */}
          <rect x="160" y="128" width="760" height="38" rx="5"
            fill={CARD_BG2} stroke={TEXT} strokeWidth="1.6" />
          ...
          <rect x="244" y="136" width="330" height="20" rx="4"
            fill={CARD_BG} stroke="#3a3a5c" strokeWidth="1" />
          <text x="409" y="151" textAnchor="middle"
            fontSize="15" fontFamily={FONT} fill={MUTED}>SimpleApp.com</text>

          {/* Nav links */}
          <text x="634" y="152" fontSize="15" fontFamily={FONT} fill={MUTED}>Home</text>
          <text x="690" y="152" fontSize="15" fontFamily={FONT} fill={GREEN_S} fontWeight="bold">Upload</text>
          <text x="756" y="152" fontSize="15" fontFamily={FONT} fill={MUTED}>Gallery</text>

          {/* Fake page content */}
          <rect x="160" y="182" width="640" height="13" rx="3" fill="#2e2e4a" />
          <rect x="160" y="203" width="560" height="11" rx="3" fill="#252538" />
          <rect x="160" y="222" width="600" height="11" rx="3" fill="#252538" />
          <rect x="160" y="241" width="490" height="11" rx="3" fill="#252538" />
          ...
          <text x="276" y="300" textAnchor="middle"
            fontSize="27" fontWeight="bold" fontFamily={FONT} fill={GREEN_S}>↑ Upload</text>

          {/* Gallery button */}
          <rect x="408" y="276" width="140" height="34" rx="6"
            fill={CARD_BG2} stroke={TEXT} strokeWidth="1.6" />
          <text x="478" y="299" textAnchor="middle"
            fontSize="20" fontFamily={FONT} fill={TEXT}>Gallery</text>
        </g>

        <text x="540" y="456" textAnchor="middle"
          fontSize="30" fontFamily={FONT} fill={TEXT}
        ...
        <g opacity={upOp} transform={`translate(0, ${upSlide})`} filter="url(#sk)">
          ...
          <rect x="150" y="604" width="780" height="328" rx="9"
            fill={CARD_BG} stroke={TEXT} strokeWidth="2.8" strokeDasharray="14 6" />

          {/* Header strip */}
          <rect x="160" y="616" width="760" height="40" rx="5"
            fill={CARD_BG2} stroke={TEXT} strokeWidth="1.6" />
          <text x="210" y="643" textAnchor="middle"
            fontSize="24" fontFamily={FONT} fill={TEXT}>↑</text>
          <text x="330" y="643" fontSize="23" fontWeight="bold"
            fontFamily={FONT} fill={TEXT}>Upload Media</text>

          {/* ─ Video icon (play circle) ─ */}
          <circle cx="232" cy="724" r="46" fill={CARD_BG2} stroke={TEXT} strokeWidth="2.2" />
          <circle cx="232" cy="724" r="29" fill="#2e2e4a" stroke={TEXT} strokeWidth="1.6" />
          <polygon points="223,715 223,733 250,724" fill={TEXT} />
          <text x="232" y="791" textAnchor="middle"
            fontSize="19" fontFamily={FONT} fill={TEXT}>Video 1</text>

          {/* ─ Image icon ─ */}
          <rect x="308" y="688" width="96" height="76" rx="5"
            fill={CARD_BG2} stroke={TEXT} strokeWidth="2.2" />
          <path d="M 316 756  L 340 728  L 364 744  L 388 726  L 396 756 Z" fill="#2e2e4a" />
          <circle cx="390" cy="698" r="10" fill="#7c6a00" stroke={TEXT} strokeWidth="1.6" />
          <text x="356" y="791" textAnchor="middle"
            fontSize="19" fontFamily={FONT} fill={TEXT}>Image 1</text>

          {/* ─ Add More ─ */}
          <rect x="438" y="688" width="80" height="76" rx="5"
            fill={CARD_BG2} stroke={TEXT} strokeWidth="1.6" strokeDasharray="5 3" />
          <text x="478" y="734" textAnchor="middle"
            fontSize="42" fontFamily={FONT} fill={TEXT}>+</text>
          <text x="478" y="791" textAnchor="middle"
            fontSize="19" fontFamily={FONT} fill={TEXT}>Add More</text>

          {/* ─ File list (appears one by one) ─ */}
          <g opacity={f1} transform={`translate(${(1 - f1) * -28}, 0)`}>
            <text x="542" y="704" fontSize="20" fontFamily={FONT} fill="#aaaacc">
              🖼  vacation_beach.jpg · 2.4 MB
            </text>
          </g>
          <g opacity={f2} transform={`translate(${(1 - f2) * -28}, 0)`}>
            <text x="542" y="732" fontSize="20" fontFamily={FONT} fill="#aaaacc">
              📸  birthday_party.jpg · 3.1 MB
            </text>
          </g>
          <g opacity={f3} transform={`translate(${(1 - f3) * -28}, 0)`}>
            <text x="542" y="760" fontSize="20" fontFamily={FONT} fill="#aaaacc">
          ...
          <rect x="160" y="814" width="178" height="48" rx="5"
            fill="#2e2e4a" stroke={TEXT} strokeWidth="2.2" />
          <text x="249" y="845" textAnchor="middle"
            fontSize="26" fontWeight="bold" fontFamily={FONT} fill={TEXT}>PHOTO</text>
          <rect x="356" y="814" width="178" height="48" rx="5"
            fill="#2e2e4a" stroke={TEXT} strokeWidth="2.2" />
          <text x="445" y="845" textAnchor="middle"
            fontSize="26" fontWeight="bold" fontFamily={FONT} fill={TEXT}>VIDEO</text>
          ...
          >
            ...
            <text x="318" y="910" textAnchor="middle"
              fontSize="30" fontWeight="bold" fontFamily={FONT} fill={GREEN_S}>Upload</text>
          </g>
        </g>
        ...
        <g opacity={stOp} transform={`translate(0, ${stSlide})`}>
          ...
          <text x="734" y="1104" textAnchor="middle"
            fontSize="36" fontWeight="bold" fontFamily={FONT} fill={TEXT} filter="url(#sk)">
            SUPABASE
          </text>
          <image
          ...
          <g filter="url(#sk)">
            <rect x="614" y="1478" width="288" height="22" rx="5"
              fill="#2e2e4a" stroke={TEXT} strokeWidth="1.6" />
            <rect x="614" y="1478" width={288 * fill} height="22" rx="5"
              fill={GREEN_S} />
          </g>

          <text x="758" y="1526" textAnchor="middle"
            fontSize="22" fontFamily={FONT} fill={TEXT} filter="url(#sk)">
          ...
          >
            <rect x="648" y="1545" width="220" height="40" rx="7"
              fill="#3d1010" stroke="#ff6b6b" strokeWidth="2" filter="url(#sk)" />
            <text x="758" y="1572" textAnchor="middle"
              fontSize="26" fontFamily={FONT} fill="#ff6b6b" fontWeight="bold" filter="url(#sk)">
              1 GB LIMIT
            </text>
          </g>
        </g>
        ...
        <g opacity={uOp} transform={`translate(${uSlide}, 0)`}>
          ...
          <path
            d="M 68 1208  Q 68 1188, 90 1188  L 376 1188
               ...
               Q 68 1274, 68 1252 Z"
            fill="#3d3008" stroke={TEXT} strokeWidth="2.2" filter="url(#sk)"
          />

          <g filter="url(#sk)">
            {/* Back-left person */}
            <circle cx="146" cy="1356" r="30" fill="#3a3a5c" stroke={TEXT} strokeWidth="2.2" />
            <path d="M 122 1388  Q 146 1406, 170 1388  L 167 1462  Q 146 1478, 125 1462 Z"
              fill="#3a3a5c" stroke={TEXT} strokeWidth="2.2" />

            {/* Back-right person */}
            <circle cx="310" cy="1356" r="30" fill="#3a3a5c" stroke={TEXT} strokeWidth="2.2" />
            <path d="M 286 1388  Q 310 1406, 334 1388  L 331 1462  Q 310 1478, 289 1462 Z"
              fill="#3a3a5c" stroke={TEXT} strokeWidth="2.2" />

            {/* Front center (larger) */}
            <circle cx="228" cy="1362" r="36" fill="#4a4a6c" stroke={TEXT} strokeWidth="2.6" />
            <path d="M 200 1400  Q 228 1420, 256 1400  L 253 1480  Q 228 1498, 203 1480 Z"
              fill="#4a4a6c" stroke={TEXT} strokeWidth="2.6" />
            {/* Crosshatch on body */}
            {[-18, -9, 0, 9, 18].map((dx, j) => (
              <line key={j}
                x1={228 + dx} y1={1403} x2={228 + dx} y2={1477}
                stroke={TEXT} strokeWidth="0.9" opacity="0.22"
              />
            ))}
          </g>
          ...
          <text x="228" y="1538" textAnchor="middle"
            fontSize="38" fontFamily={FONT} fill={TEXT} filter="url(#sk)">Users</text>
        </g>
